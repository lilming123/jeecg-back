 ...
 * @Version: V1.0
 */
@ApiModel(value="procurement_order_supplier对象", description="采购审批表")
@Data
@TableName("procurement_order_supplier")
public class ProcurementOrderSupplier implements Serializable {
